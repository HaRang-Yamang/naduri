...
<%
	Spot s = (Spot)request.getAttribute("spot");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<section>
        ...
        <div class="adminArea">
            <div class="head_area">
                <h2 class="notice_head">맛집 데이터 수정하기</h2>
                <hr class="green_bar">
            </div>
            <div class="dtable_area">
            	<form action="/naduri/updateFoodData.ad" method = "post" enctype="multipart/form-data" id="dababy">
            	<input type="hidden" name="s_id" value="<%= s.getS_id() %>"/>
                 <table class="d_table">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span class="box">
                                <input type="text" id="food_title" size="70" name="s_name" value="<%= s.getS_name() %>">
                            </span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><span class="box"><input type="text" id="food_tell" size="70" name="s_tel" value="<%= s.getS_tel() %>"></span></td>
                    </tr>
                    <!-- NAME -->
                    <tr>
                        <td class="data_title">운영시간</td>
                        <td colspan="3"><span class="box"><input type="text" id="food_time" size="70" name="s_date" value="<%= s.getS_time() %>"></span></td>
                    </tr>
                    <tr>
                        <td class="data_title">위치</td>
                        <td colspan="3">
                            <span class="box">
                                <input type="text" id="food_site" size="70" name="s_address" value="<%= s.getS_address() %>">
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <span class="box">
                                 <input type="text" id="food_location" size="70" name="s_lat" value="<%= s.getS_lat() %>">
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                             <input type="text" id="food_content" size="70" name="s_lng" value="<%= s.getS_lng() %>">
                        </td>
                    </tr>
            ...
            <div class="submit_btn">
                ...
                <button type="submit" form="dababy" id="submit_btn" style="cursor: pointer;">데이터 등록</button>
