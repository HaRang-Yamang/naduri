...
public class InsertHeritage2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			list = service.selectList(); // 서버에 있는 문화재 DB를 list에 담기
			...
			try{
				...
				while(true){
					...
					String url = "http://www.cha.go.kr/cha/SearchKindOpenapiList.do?ccbaMnm1="+page;
...
//							
//							heritage.add(new Heritage(title, events));
...
//							b.setBcontent(bcontent);
			...
			request.setAttribute("heritage", list);
