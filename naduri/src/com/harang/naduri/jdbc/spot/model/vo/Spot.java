...
public Spot(int spot_id, int l_no, String spot_name, String spot_tel, String spot_time, String spot_location,
		int spot_lat, int spot_long, String s_status, String spot_date, int spot_count, String spot_file) {
	super();
...
public String toString() {
	return "Spot [spot_id=" + spot_id + ", l_no=" + l_no + ", spot_name=" + spot_name + ", spot_tel=" + spot_tel
			+ ", spot_time=" + spot_time + ", spot_location=" + spot_location + ", spot_lat=" + spot_lat
			+ ", spot_long=" + spot_long + ", s_status=" + s_status + ", spot_date=" + spot_date + ", spot_count="
			+ spot_count + ", spot_file=" + spot_file + "]";
}
