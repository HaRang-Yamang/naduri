...
/**
 * Servlet implementation class AdminSpotInsert
 */
@WebServlet("/spotInsert.ad")
public class AdminSpotInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSpotInsert() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 장소정보 저장하러 서비스 가기
		int result2 = service.AdminSpotInsert(s);
		


		response.sendRedirect("spotList.ad");		
