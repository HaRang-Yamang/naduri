...
/**
 * Servlet implementation class LikeReviewSelectOne
 */
@WebServlet("/likeReviewSelectOne.do")
public class LikeReviewSelectOne extends HttpServlet {
	private static final long serialVersionUID = 1038L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LikeReviewSelectOne() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Review re = new selectOneService().selectOneLikeReview(r_no, m_no);
