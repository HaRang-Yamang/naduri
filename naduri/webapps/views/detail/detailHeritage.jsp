...
com.harang.naduri.jdbc.bookmark.model.vo.*" %>
<%
		...
		Bookmark b = (Bookmark)request.getAttribute("b");
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="infoArea">
	...
	$(function(){
	 ...
	 --> 
				...
				<img src="<%=l.getA_name()%>" width="1000px" height="536px"
				...
				<div class="infoDetailArea">
					...
					<div class="infoDetail">
						<div class="a">
							...
							<details>
								...
								<div>
									<p>1904년의 큰 불로 대부분의 건물들이 불에 타 없어지자 서양식 건물인석조전들이 지어지면서, 원래
										궁궐 공간의 조화를 잃어버리게 되었다. 그중 가장 큰 변화는 정문이 바뀐 것이다. 덕수궁의 정문은 남쪽에
										있던인화문이었는데, 다시 지으면서 동쪽에 있던 대안문을 수리하고 이름도대한문으로 고쳐 정문으로 삼았다. 비록
										조선 후기에 궁궐로 갖추어진 곳이지만, 구한말의 역사적현장이었으며 전통목조건축과 서양식의 건축이 함께 남아있는
										곳으로조선왕조의 궁궐 가운데 특이한 위치를 차지하고 있다.</p>
								</div>
					...
					<div class="slider-images">
						<div id="carouselExampleIndicators" class="carousel slide"
							data-bs-ride="carousel" style="width: 1000px;">
							<div class="carousel-indicators" style="margin-left: 10px;">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="<%=heri.getImageUrl() %>" width="1000px"
										height="536px" class="d-block w-100" alt="...">
								</div>
								<div class="carousel-item">
									<img src="<%=heri.getImageUrl() %>" width="1000px"
										height="536px" class="d-block w-100" alt="...">
	...
	-->
						...
						<img src="<%=heri.getImageUrl() %>" width="1000px" height="536px"
							class="d-block w-100" alt="...">
						<div class="infoDetailArea">
							<!-- 테이블-->
							<div class="infoTable">
									...
									<details>
										...
										<div>
											<p>1904년의 큰 불로 대부분의 건물들이 불에 타 없어지자 서양식 건물인석조전들이 지어지면서, 원래
												궁궐 공간의 조화를 잃어버리게 되었다. 그중 가장 큰 변화는 정문이 바뀐 것이다. 덕수궁의 정문은 남쪽에
												있던인화문이었는데, 다시 지으면서 동쪽에 있던 대안문을 수리하고 이름도대한문으로 고쳐 정문으로 삼았다. 비록
												조선 후기에 궁궐로 갖추어진 곳이지만, 구한말의 역사적현장이었으며 전통목조건축과 서양식의 건축이 함께
												남아있는 곳으로조선왕조의 궁궐 가운데 특이한 위치를 차지하고 있다.</p>
										</div>
					...
					<!-- 탭 -->
					<div class="write_btn">
						<a href="/naduri/views/reviewWrite.jsp?l_no=<%= sendL_no %>&"><input
							type="button" value="리뷰 쓰기" id="insertreview"></a>
					</div>
					<div class="write_btn">
						<a href="/naduri/views/qnaWrite.jsp?l_no=<%= sendL_no %>"><input
							type="button" value="QNA 쓰기" id="insertqna"></a>
					</div>
					<div id="container">
