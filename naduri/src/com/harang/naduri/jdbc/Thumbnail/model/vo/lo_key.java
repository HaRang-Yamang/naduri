...
public class lo_key implements Serializable {
	...
	public lo_key(int l_no, int ls_code, String local_name, int count_all, ArrayList<String> keyword, int a_no,
			String a_name, String a_status, int r_no, int m_no, int n_no, int s_id, int flevel) {
		super();
		this.l_no = l_no;
