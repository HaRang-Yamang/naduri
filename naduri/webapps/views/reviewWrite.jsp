			...
			<form id="insertForm" action="/naduri/insert.re" method="post"
				...
				<div class="reviewWriteArea">
						...
						<table>
							...
							<tr>
								<div class="range_part">
									...
									<td><input type="range" class="slider" id="range" max="5"
										...
										<span class="slider_txt"><span id="value1"></span>점</span>
									</td>
								</div>
							</tr>
							<tr>
								<td class="review_title">방문 일자</td>
								<td><input type="text" id="yy" name="r_period"
									size="10" maxlength="4" placeholder="2021"
									style="border: solid 2px #b7b7b7"> <input type="text"
									id="mm" name="r_period" size="9" maxlength="2"
									placeholder="월" style="border: solid 2px #b7b7b7"> <input
									type="text" id="dd" name="r_period" size="9"
									maxlength="2" placeholder="일" style="border: solid 2px #b7b7b7"></td>
							<tr>
								<td class="review_title">여행 유형</td>
								<td><input type="radio" name="r_with" id="t_type1"
									value="1"><label for="t_type1">혼자</label>
									<input type="radio" name="r_with" id="t_type2" value="2"><label
									for="t_type2">친구</label> <input
									type="radio" name="r_with" id="t_type3" value="3"><label
									for="t_type3">썸</label> <input
									type="radio" name="r_with" id="t_type4" value="4"><label
									for="t_type4">커플</label> <input
							...
							<tr>
								...
								<td><input type="text" id="review_title" name="r_title"
									placeholder="30자 이내 작성" size="69%"></td>
							</tr>
							<tr>
								<td class="review_title">내용</td>
								<td><textarea id="review_textArea" name="r_content"
										cols="70" rows="15" style="resize: none;"></textarea></td>
							</tr>
					...
					<div class="fileArea" id="fileArea">
						<input type="file" accept="image/*" name="thumbImg1"
							id="thumbImg1" onchange="loadImg(this,1)" /> <input type="file"
							name="thumbImg2" id="thumbImg2" onchange="loadImg(this,2)" /> <input
							type="file" name="thumbImg3" id="thumbImg3"
							onchange="loadImg(this,3)" /> <input type="file"
							name="thumbImg4" id="thumbImg4" onchange="loadImg(this,4)" />
					</div>
